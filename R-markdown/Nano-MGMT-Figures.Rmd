...
ggplot(MGMT_RunSum, aes(x=Method, y=Depth))+
 ...
 # scale_fill_discrete(guide="none")+
  ...
  #stat_summary(fun=median, geom="point", shape= "-", size=14, color="black",alpha = 0.8,position = position_dodge(0.9), aes(fill=Known_status))+
  #ylim(0,125)+
...
FOUR_CpGs <- read.csv("Data/newFOUR_CPGs.csv")
...
ggplot(t3, aes(x=Known_status, y=CumMeth, color = Series))+
