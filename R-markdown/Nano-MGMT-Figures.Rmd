...
ggplot(Compare_CpGs_Radium, aes(x=Pyro_4_CpG_average, y=Nano_4_CpG_average)) +
  geom_smooth(method = "lm", color="black") +
  geom_point(aes(size=Coverage, color=Pyro_Methylation_Status), alpha = 0.7 )+
  stat_regline_equation(label.y = 20, label.x = 60,aes(label = ..rr.label..),color = "black", size=5)+
...
ggplot(p, aes(x=Known_status, y=Average_Meth_Nano))+
  geom_hline(yintercept = 10)+
  geom_beeswarm(aes(color = Known_status), alpha = 0.8,size = 5, cex=4)+
